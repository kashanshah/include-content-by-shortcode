...
<div class="wrap">
	...
	<?php    echo "<h4>" . __( 'Thank you for installing. This plugin allows the user to add single content in multiple posts and pages by means of a shortcode. It is used to fulfill the concept of PHP\'s \'include\' function.' ) . "</h4>"; ?>
	...
	<br/><br/><br/>
	<p style="text-align:right">For help contact the developers at <a href="mailto:contact@kashanshah.ga"><strong><em>contact@kashanshah.ga</em></strong></a> or visit <a href="http://kashanshah.ga"><strong><em>www.kashanshah.ga</em></strong></a></p>
